...
public class OrdenamientoAscendente  implements Runnable{
    ...
    public OrdenamientoAscendente(String tipoOrdenamiento, long velocidad,OpcionVista view,GraficaVista view3) {
    ...
    private static void merge(Datos[] lista_a_Ordenar,int inicio,int medio,int fin,GraficaOrdenadaVista view2,Long velocidad,GraficaVista view3){
